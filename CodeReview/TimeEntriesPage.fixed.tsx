...
//
//
// Исправил две важные проблемы
// 1. useEffect(load()) без deps - бесконечный цикл запросов. Добавлен массив зависимостей.
// 2. await load() вместо entries.push(body); setEntries(entries).
//    Теперь список entries приходит актуальный с сервера
//
//
